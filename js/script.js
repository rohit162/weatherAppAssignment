...
let apiKey = "4080f16b9b51b74dd8859c04076de170";
...
// const apiKey = '4080f16b9b51b74dd8859c04076de170';
...
//     fetch(`https://api.openweathermap.org/data/2.5/weather?q=${locationInput}&units=${unit}&appid=${apiKey}`)
...
//     weatherDisplay.innerHTML = `<div class="card" style="width: 20rem;">
//         <div class="card-body">
//           <h5 class="card-title">Weather in ${data.name}, ${data.sys.country}</h5>
//           <h6 class="card-subtitle mb-2 text-body-secondary">
//           Temperature: ${temperature} °${unitSelector.options[unitSelector.selectedIndex].text}
//           </h6>
...
//     errorDisplay.innerHTML = `<p>Error: ${errorMessage}</p>`;
